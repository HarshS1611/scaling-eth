                        ...
                        >
                            ...
                            <div className="flex mb-5 justify-between w-full px-5">
                                <div className="flex justify-around gap-80 pl-20 w-[50%]">
                                    <div className="bg-white text-black py-2 px-2 rounded-md">                <FaBuildingColumns className={ "text-[#FBC741] h-10 w-10"} />
                                    </div>
                                    <div className="bg-white text-black py-2 px-2 rounded-md"><HiOfficeBuilding className={ "text-[#FBC741] h-10 w-10"} /></div>
                                </div>
                                <div className="bg-white text-black py-2 px-2 rounded-md"><TbBuildingCircus className={ "text-[#FBC741] h-10 w-10"} /></div>
                            </div>
                        ...
                        >
                            ...
                            <div className="flex gap-5 w-full justify-between">
                                ...
                                <div className="flex flex-col gap-5 w-full bg-[#1E1E1E] rounded-md py-5 px-5">
                                    ...
                                    <p className="flex justify-end gap-4 items-center font-thunder text-5xl">
                                        <svg width="41" height="47" viewBox="0 0 31 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M11.3955 13.325H14.325C15.9362 13.325 17.4814 13.965 18.6207 15.1043C19.76 16.2436 20.4 17.7888 20.4 19.4H10.9487L10.95 20.75H21.75V19.4C21.7458 17.9636 21.3307 16.5583 20.5539 15.35H24.45C25.7261 15.3497 26.9762 15.711 28.0552 16.3923C29.1343 17.0735 29.9982 18.0466 30.5466 19.1989C27.3539 23.4122 22.1847 26.15 16.35 26.15C12.6227 26.15 9.46502 25.3535 6.90002 23.9563V11.3959C8.54245 11.6311 10.0934 12.2967 11.3955 13.325ZM5.55002 23.45C5.55002 23.808 5.40779 24.1514 5.15462 24.4046C4.90144 24.6578 4.55807 24.8 4.20002 24.8H1.50002C1.14198 24.8 0.798604 24.6578 0.54543 24.4046C0.292256 24.1514 0.150024 23.808 0.150024 23.45V11.3C0.150024 10.942 0.292256 10.5986 0.54543 10.3454C0.798604 10.0922 1.14198 9.95 1.50002 9.95H4.20002C4.55807 9.95 4.90144 10.0922 5.15462 10.3454C5.40779 10.5986 5.55002 10.942 5.55002 11.3V23.45ZM23.1 4.55C24.1742 4.55 25.2043 4.9767 25.9638 5.73622C26.7233 6.49574 27.15 7.52587 27.15 8.6C27.15 9.67413 26.7233 10.7043 25.9638 11.4638C25.2043 12.2233 24.1742 12.65 23.1 12.65C22.0259 12.65 20.9958 12.2233 20.2362 11.4638C19.4767 10.7043 19.05 9.67413 19.05 8.6C19.05 7.52587 19.4767 6.49574 20.2362 5.73622C20.9958 4.9767 22.0259 4.55 23.1 4.55ZM13.65 0.5C14.7242 0.5 15.7543 0.926695 16.5138 1.68622C17.2733 2.44574 17.7 3.47587 17.7 4.55C17.7 5.62413 17.2733 6.65426 16.5138 7.41378C15.7543 8.17331 14.7242 8.6 13.65 8.6C12.5759 8.6 11.5458 8.17331 10.7862 7.41378C10.0267 6.65426 9.60002 5.62413 9.60002 4.55C9.60002 3.47587 10.0267 2.44574 10.7862 1.68622C11.5458 0.926695 12.5759 0.5 13.65 0.5Z" fill="#FF9314" />
                                        </svg>
                                        2034{" "}
                                    </p>
                                </div>
